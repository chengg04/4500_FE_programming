...
int main(int argc, char **argv){
	...
	for (lambda = 10 ; lambda < 50; lambda = lambda + 10){
		printf("\n---------lambda = %g---------\n", lambda);
...
int readData(char *filename, int *assetNum, int *dayNum, double **price){
	...
	n = n + 1;
	//strtok function is used to get each value between comma(use bufferRow to get the first value and use NULL to get the rest value)
