...
bag::bag(int Ninput,int Tinput,double alphaInput, double piInput, int nameInput, double P0input)
	:N(Ninput),T(Tinput),alpha(alphaInput),pi(piInput),name(nameInput),P0(P0input){//constructor initializer list, more efficient
	status = WAITING;
}
